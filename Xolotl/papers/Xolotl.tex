...
how off-the-record messaging \cte{OtR??} chains key exchanges.
...
that omits advertising a new update and instead transmits the senders
current public key $A = a G$ in each packet and does the key exchange
between $A$ and the receivers last seen public key $B = b G$. 
...
obstacles to building quantum computers.  In this way, 

This removes worries
about the ratchet
