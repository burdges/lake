...
\begin{frame}[t]{Anonymity requires latancy}
\begin{columns}[T]
\column{0.8\textwidth}
...
\hspace*{5pt} Tor is inherently vulnerable to corrolation attacks \\
...
\begin{itemize}
\item be tolerent to high latency, while still
...
A quantum adversary can evolve all \\
 \hspace*{2pt} ratchets, inculding yours.
...
\hspace*{2pt} a post-quantum key excahgne.
